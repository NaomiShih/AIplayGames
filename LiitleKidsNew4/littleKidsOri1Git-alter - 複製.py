...
Xlist  = []#紀錄每個X值
Ylist  = []#紀錄每個y值
Kindlist = [Board, Nails, TrampolineUP, conveyor_left, conveyor_right]#紀錄每個板子的種類
count = 0#刷新板子亂數
count2 = 0
# 宣告 font 文字物件
...
class Platform:
    ...
    def Platform_float(Board, CountF):
        ...
        if Board.Y < 100:       
            ...
            if (Board.img != Board1.img) :
                if (Board.Y - Board1.Y < 20) or ((Board.X - Board1.X)**2 < 9216) :
                    Board.Y += 30
                    Board.X = random.randint(114,366)
                    
            elif (Board.img != Board2.img) :
                if (Board.Y - Board2.Y < 20) or ((Board.X - Board2.X)**2 < 9216):
                    Board.Y += 30
                    Board.X = random.randint(114,366)
                
            elif Board.img != Nails1.img:
                if (Board.Y - Nails1.Y < 35) or ((Board.X - Nails1.X)**2 < 9409):
                    Board.Y += 50
                    Board.X = random.randint(114,366)
                    
            elif Board.img != Nails2.img:
                if (Board.Y - Nails2.Y < 35) or ((Board.X - Nails2.X)**2 < 9409):
                    Board.Y += 50
                    Board.X = random.randint(114,366)
            
            elif Board.img != Nails3.img:
                if(Board.Y - Nails3.Y < 35) or ((Board.X - Nails3.X)**2 < 9409):
                    Board.Y += 50
                    Board.X = random.randint(114,366)
                    
            elif Board.img != Nails4.img:        
                if (Board.Y - Nails4.Y < 35) or ((Board.X - Nails4.X)**2 < 9409):
                    Board.Y += 50
                    Board.X = random.randint(114,366)
                    
            elif Board.img != TrampolineDown:
                if (Board.Y - Trampoline.Y < 16) or ((Board.X - Trampoline.X)**2 < 9409):
                    Board.Y += 30
                    Board.X = random.randint(114,366)
                    
            elif Board.img != conveyor_left:      
                if (Board.Y - conveyor_left.Y < 20) or ((Board.X - conveyor_left.X)**2 < 9216):
                    Board.Y += 30
                    Board.X = random.randint(114,366)
                    
            elif Board.img != conveyor_right:
                if (Board.Y - conveyor_right.Y < 20) or ((Board.X - conveyor_right.X)**2 < 9216):
                    Board.Y += 30
                    Board.X = random.randint(114,366)
