...
Nails1   = Platform(Xlist[4], 1241, 5,KidImg.Nails )
Nails2   = Platform(Xlist[2], 1241, 5,KidImg.Nails )
Nails3   = Platform(Xlist[7], 1241, 5,KidImg.Nails )
Nails4   = Platform(Xlist[5], 1241, 5,KidImg.Nails )
