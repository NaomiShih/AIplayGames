...
Nails2   = Platform(Xlist[2], random.randint(1100, 1200), 5,KidImg.Nails )
Nails3   = Platform(Xlist[7], random.randint(1100, 1200), 5,KidImg.Nails )
Nails4   = Platform(Xlist[5], random.randint(1100, 1200), 5,KidImg.Nails )
